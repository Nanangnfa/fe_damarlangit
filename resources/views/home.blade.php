                ...
                <div class="container">
                    ...
                    <div class="row gy-4 mt-5 justify-content-center" data-aos="fade-up" data-aos-delay="200">
                        <div class="col-xl-2 col-md-4" data-aos="fade-up" data-aos-delay="300">
                            <div class="icon-box">
                                <h1><a href=""><span data-purecounter-start="0" data-purecounter-end="232"
                                            data-purecounter-duration="3" class="purecounter"></span></a></h1>
                                <h3><a href="">Komposer</a></h3>
                            </div>
                        </div>

                        <div class="col-xl-2 col-md-4" data-aos="fade-up" data-aos-delay="300">
                            <div class="icon-box">
                                <h1><a href=""><span data-purecounter-start="0" data-purecounter-end="532"
                                            data-purecounter-duration="3" class="purecounter"></span></a></h1>
                                <h3><a href="">Judul Lagu</a></h3>
                            </div>
                        </div>

                        <div class="col-xl-2 col-md-4" data-aos="fade-up" data-aos-delay="300">
                            <div class="icon-box">
                                <h1><a href=""><span data-purecounter-start="0" data-purecounter-end="10"
                                            data-purecounter-duration="3" class="purecounter"></span></a></h1>
                                <h3><a href="">Cover Partner</a></h3>
                            </div>
                        </div>
